...
const Aboutfooter = () => {
    ...
    const items = [
        {name:"Language", answer:"English, Urdu, Hindi, Pashto, Turkish", icon:<Languages className="h-11 w-11" />},
    ...
    return(
        <>
        {
            items.map((val, indx) => {
              return(
                <div className="p-1 w-fit relative bg-white rounded-lg" key={indx}>
